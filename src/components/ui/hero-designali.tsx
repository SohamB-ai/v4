...
function render() {
    ...
    if (ctx.running) {
        ...
        // @ts-ignore
        // CUSTOMIZATION: Use purple hues (approx 270 degrees)
        // Vary slightly for effect, e.g., 260-280
        // Keep lightness around 50-60% for visibility
        const hue = 270 + Math.sin(f.update() * 0.1) * 10;
        ctx.strokeStyle = "hsla(" + Math.round(hue) + ",100%,60%,0.2)";
        // @ts-ignore
        ctx.lineWidth = 1;

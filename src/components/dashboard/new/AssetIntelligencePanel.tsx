...
const trendData = Array.from({ length: 30 }, (_, i) => ({
    day: i + 1,
    health: 90 - (i * 1.5) + (Math.random() * 5 - 2.5),
    rul: 180 - (i * 2)
}));
...
export function AssetIntelligencePanel() {
    return (
        <div className="h-full flex flex-col gap-6 font-tinos">
            ...
            <div className="flex justify-between items-start bg-white/5 backdrop-blur-md rounded-2xl border border-white/10 p-6">
                <div>
                    <h2 className="text-4xl font-bold text-white mb-2 font-inter font-tinos">Asset-21</h2>
                    <div className="flex items-center gap-4 text-slate-400 text-sm">
                        <span className="flex items-center gap-1.5"><MapPin className="w-3.5 h-3.5" /> Sector 4-B</span>
                        <span className="w-1 h-1 rounded-full bg-slate-600" />
                        <span className="flex items-center gap-1.5"><Zap className="w-3.5 h-3.5" /> Running (Load 82%)</span>
                        <span className="w-1 h-1 rounded-full bg-slate-600" />
                        <span className="font-mono text-xs border border-white/10 px-1.5 py-0.5 rounded">ID: TU-7782A</span>
                    </div>
                </div>
                <div className="text-right">
                    <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-amber-500/10 border border-amber-500/30 text-[#FFB020] text-sm font-bold font-inter animate-pulse">
                        <span className="w-2 h-2 rounded-full bg-[#FFB020]" /> WARNING
                    </div>
                </div>
            </div>
            ...
            <div className="flex flex-col gap-6 flex-1 min-h-0">
                ...
                <div className="grid grid-cols-2 gap-6 h-auto">
                    ...
                    <div className="bg-white/5 backdrop-blur-md rounded-2xl border border-white/10 p-6 flex flex-col items-center justify-center relative overflow-hidden group min-h-[250px]">
                        ...
                        <div className="relative w-48 h-48">
                            <svg className="w-full h-full transform -rotate-90">
                                ...
                                <motion.circle
                                    cx="96" cy="96" r="88" fill="none" stroke="#FFB020" strokeWidth="8" strokeLinecap="round" strokeDasharray="552"
                                    initial={{ strokeDashoffset: 552 }}
                                    animate={{ strokeDashoffset: 552 - (552 * 0.41) }} // 41%
                                    transition={{ duration: 1.5, ease: "easeOut" }}
                                />
                            </svg>
                            <div className="absolute inset-0 flex flex-col items-center justify-center">
                                <span className="text-5xl font-bold text-white font-tinos">41</span>
                                <span className="text-xs font-medium text-slate-400 uppercase tracking-widest mt-2 font-inter">Health Index</span>
                            </div>
                        </div>

                        <div className="mt-4 text-center max-w-xs">
                            <p className="text-white font-medium text-sm leading-snug">Rapid degradation detected.</p>
                        </div>
                    </div>

                    {/* RUL Card */}
                    <div className="bg-gradient-to-br from-white/5 to-white/[0.02] backdrop-blur-md rounded-2xl border border-white/10 p-6 flex flex-col justify-center relative overflow-hidden min-h-[250px]">
                        ...
                        <div>
                            <div className="text-6xl font-bold text-white tracking-tighter mb-2 font-tinos">
                                112 <span className="text-2xl text-slate-400 font-normal ml-1 font-inter">Cycles</span>
                            </div>
                ...
                <div className="bg-white/5 backdrop-blur-md rounded-2xl border border-white/10 p-5 flex-1 min-h-[300px] flex flex-col">
                    <h3 className="text-sm font-medium text-slate-300 mb-4 font-inter">30-Day Health Trend</h3>
